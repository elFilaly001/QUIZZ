...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `courses` SET course_title=?, course_description=?, course_duration=?, course_creation_date=? WHERE course_id=?";
    $stmt = mysqli_prepare($conn, $sql);

    mysqli_stmt_bind_param($stmt, "ssssi", $course_title, $course_description, $course_duration, $course_creation_date, $course_id);
