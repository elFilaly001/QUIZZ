            ...
            <div class="card profile-tab">
              ...
              <div class="card-body custom-tab-1">
                <ul class="nav nav-tabs mb-3">
                  <li class="nav-item">
                    <a href="#my-posts" data-toggle="tab" class="nav-link pb-2 active show">Professors</a>
                  </li>
                  <li class="nav-item">
                    <a href="#about-me" data-toggle="tab" class="nav-link pb-2">Librarian</a>
                  </li>
                  <li class="nav-item">
                    <a href="#profile-settings" data-toggle="tab" class="nav-link pb-2">Other</a>
                  </li>
                </ul>
                    ...
                    <div class="table-responsive">
                      <table class="table table-responsive-md">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="images/profile/education/pic1.jpg" class="rounded-circle" width="35" alt="" />
                            </td>
                            <td>Angelica Ramos</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img src="images/profile/education/pic2.jpg" class="rounded-circle" width="35" alt="" />
                            </td>
                            <td>Bradley Greer</td>
                            <td>
                              <span class="badge badge-rounded badge-danger">Unpaid</span>
                            </td>
                            <td>11 July 2020</td>
                            <td>$200</td>
                            <td>#54682</td>
                          ...
                          <tr>
                            <td>
                              <img src="images/profile/education/pic3.jpg" class="rounded-circle" width="35" alt="" />
                            </td>
                            <td>Cedric Kelly</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img src="images/profile/education/pic4.jpg" class="rounded-circle" width="35" alt="" />
                            </td>
                            <td>Caesar Vance</td>
                            <td>
                              <span class="badge badge-rounded badge-danger">Unpaid</span>
                    ...
                    <div class="table-responsive">
                      <table class="table table-responsive-md">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="images/profile/education/pic6.jpg" class="rounded-circle" width="35" alt="" />
                            </td>
                            <td>Angelica Ramos</td>
                            <td>
                              <span class="badge badge-rounded badge-success">Paid</span>
                          ...
                          <tr>
                            <td>
                              <img src="images/profile/education/pic8.jpg" class="rounded-circle" width="35" alt="" />
                            </td>
                            <td>Cedric Kelly</td>
                            <td>
                              <span class="badge badge-rounded badge-warning">Pending</span>
                          ...
                          <tr>
                            <td>
                              <img src="images/profile/education/pic10.jpg" class="rounded-circle" width="35" alt="" />
                            </td>
                            <td>Caesar Vance</td>
                            <td>
                              <span class="badge badge-rounded badge-danger">Unpaid</span>
