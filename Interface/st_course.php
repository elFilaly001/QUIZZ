...
$coursesTable = $conn->query("SELECT * FROM courses")->fetch_all();
$targetCourse = array_values(array_filter($coursesTable, fn ($course) => $course[0] == $_GET['id']))[0];
?>
            ...
            <div class="container-fluid">
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="mb-0"><?php echo $targetCourse[1] ?></h4>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
									...
									<div class="card-body pb-0">
										<ul class="list-group list-group-flush">
											<li class="list-group-item d-flex px-0 justify-content-between">
												...
												<span class="mb-0"><?php echo $targetCourse[3] ?></span>
											</li>
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Date</strong>
												<span class="mb-0"><?php echo $targetCourse[4] ?></span>
											</li>
										</ul>
									</div>
								</div>
					...
					<div class="col-xl-9 col-xxl-8 col-lg-8">
						<div class="card">
							<div class="card-body">
								<div><?php echo $targetCourse[2] ?></div>
                                <br>
