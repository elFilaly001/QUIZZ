          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul aria-expanded="false">
                ...
                <li><a href="add-quizzes.html">Add Quizzes</a></li>
                <li><a href="edit-quizzes.html">Edit Quizzes</a></li>
                <li><a href="about-quizzes.html">About Quizzes</a></li>
              </ul>
            </li>
            <li>
              <a
          ...
          <div class="row page-titles mx-0">
            ...
            >
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                  <a href="javascript:void(0);">Add Quizz</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Quizz Details</h4>
                </div>
                <div class="card-body">
                  <form action="./Quizz/add.php" method="post">
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          <label class="form-label">Course Associate</label>
